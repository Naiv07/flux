...
export function QRModal({ roomCode, onClose, connectionState, connectionStatus }: Props) {
  ...
  // True once the peer has joined and we're actively negotiating
  const peerJoined =
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  {peerJoined ? "Peer found! Establishing connection..." : "Point camera at QR — connects instantly"}
                </p>
              </div>
              <motion.button
                whileTap={{ scale: 0.88 }}
            ...
            <div style={{ position: "relative", padding: "8px" }}>
              ...
              {/* QR code fades when peer has joined */}
              <div style={{
                background: "#ffffff",
                borderRadius: "16px",
                padding: "14px",
